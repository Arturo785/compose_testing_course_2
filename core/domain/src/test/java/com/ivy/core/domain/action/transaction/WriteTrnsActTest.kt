...
internal class WriteTrnsActTest {
    ...
    fun `Test create new transaction with expense`() = runBlocking<Unit> {
        // Now instead of creating every object in the setup or each test we use the data
        // generators and we can reuse or add more data using the generator and copy to the value
        // provided like this
